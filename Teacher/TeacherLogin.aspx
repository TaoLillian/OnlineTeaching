<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherLogin.aspx.cs" Inherits="OnlineTeaching.TeacherLogin" %>
...
<body>
    ...
    <form method="post" runat="server" > 
        ...
        <div style="text-align:center">
            ...
            <div>密码：<asp:TextBox ID="TextBox2" runat="server" type="password"></asp:TextBox>
